...
import 'package:flutter_http_request/RegisterResponse.dart';
import 'coupon/titlebar.dart';
...
class RegisterState extends State<RegisterScreen> {
  ...
  final String baseUrl =HttpAddressManager().domain;
  ...
  Future _getCapcha() async {
    ...
    Response res = await dio.get(HttpAddressManager().getCaptchaSMS(),
